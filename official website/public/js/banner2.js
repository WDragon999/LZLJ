$(function(){
    ...
    var li = $("#banner_ctr>ul>li[class!='first-item'][class!='last-item']");
    var int=setInterval(autoSlide,3000);

    li.click(function(){
        show($(this).index("#banner_ctr>ul>li[class!='first-item'][class!='last-item']"));
        window.clearInterval(int);
        int=setInterval(autoSlide,3000);
    })
    function autoSlide(){
    ...
    function show(index){
        $("#drag_ctr,#drag_arrow").stop(false,true).animate({left:index*115+18},300);
